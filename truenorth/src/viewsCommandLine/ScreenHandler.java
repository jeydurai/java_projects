...
public class ScreenHandler {
	...
	public static final String HEADER = " WELCOME TO TrueNorth DATA PROCESSOR ";
	public static final String SUB_HEADER1 = " Version 1.01.01";
	public static final String SUB_HEADER2 = " a unique Data Processor Console Application";
	...
	public static final String SUB_HEADER6 = " TDP is meant to be for internal use only and doesn't have any copyright";

	public static final String footer = " THANK YOU FOR USING TrueNorth DATA PROCESSOR ";
	public static final String SUB_FOOTER1 = " Hope you have had a fun using this tool";
	public static final String SUB_FOOTER2 = " TDP is still under modern development";
